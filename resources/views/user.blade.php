...
<body class="bg-[#FCF8F5] bg-[url('../../public/bg-user.png')] bg-cover bg-center">
    ...
    <div class="lg:container w-full h-auto mx-auto mt-[50px] px-4 py-8">
        <!-- Search Bar -->
            ...
            @if(session('error'))
            <div id="toast-warning" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 absolute z-50 left-1/2 top-2" role="alert">
