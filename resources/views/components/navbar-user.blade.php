                    ...
                    <a href="{{ route('checkout.show') }}" class="text-gray-50 dark:text-white relative">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 3h18l1 9H4L3 3z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M6 18c0 1.104.896 2 2 2s2-.896 2-2H6zM16 18c0 1.104.896 2 2 2s2-.896 2-2H16z" />
                        </svg>
                    </a>
...
<div id="toast-success"
    class=" fixed left-1/2 opacity-0 z-50 transition-opacity translate-x-3 right-2 top-4 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
    role="alert">
    <div
