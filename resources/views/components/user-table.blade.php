...
@props(['books', 'categories', 'customer'])
...
<div class="relative overflow-x-auto sm:rounded-lg">
    ...
    <div
        ...
        <div>
            ...
            {{-- Button toggle add user --}}
            <button data-modal-target="userAdd" data-modal-toggle="userAdd"
            ...
            {{-- Modal add user --}}
            <div id="userAdd" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        {{-- Form simpan user menggunakan fungsi storeUser di CustomersController --}}
                ...
                <tr
                    ...
                    <td class="px-6 py-4">
                        ...
                        <button type="button"
                            ...
                            data-modal-target="userDelete{{ $item->customer_id }}"
                            data-modal-toggle="userDelete{{ $item->customer_id }}">
                        ...
                        {{-- Modal Delete user --}}
                        <div id="userDelete{{ $item->customer_id }}" tabindex="-1" aria-hidden="true"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div
                                        ...
                                        <button type="button"
                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                            data-modal-hide="userDelete{{ $item->customer_id }}">
                                    ...
                                    <div
                                        ...
                                        {{-- Form delete user menggunakan fungsi delCustomers di CustomersController --}}
                                        <form action="{{ route('users.delete', $item->customer_id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button data-modal-hide="userDelete{{ $item->customer_id }}"
                                                type="submit"
                                        ...
                                        {{-- Button Submit delete uyyser --}}
                                        <button data-modal-hide="userDelete{{ $item->customer_id }}" type="button"
                        ...
                        <button type="button"
                            ...
                            data-modal-target="userEdit{{ $item->customer_id }}"
                            data-modal-toggle="userEdit{{ $item->customer_id }}">
                        ...
                        {{-- Modal edit user --}}
                        <div id="userEdit{{ $item->customer_id }}" tabindex="-1" aria-hidden="true"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <!-- Modal content -->
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    {{-- Form edit user menggunakan fungsi updateCustomers di CustomersController --}}
                                    <form class="p-4 md:p-5" action="{{ route('users.update', $item->customer_id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="grid gap-4 mb-4 grid-cols-1">
