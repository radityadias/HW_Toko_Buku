...
<div class="relative overflow-x-auto sm:rounded-lg">
    <div
        ...
        <div>
            {{-- Button dropdown untuk filter kategori --}}
            ...
            <div id="dropdownAction"
                class="z-10 hidden border bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                    <li>
                        {{-- Menampilkan semua data buku di BooksController --}}
                        <a href="{{ route('books.sort') }}"
                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">All</a>
                    </li>
                    @foreach ($categories as $category)
                        <li>
                            {{-- Menampilkan data buku sesuai filter yang dipilih menggunakan fungsi GetFilterBooks di BooksController --}}
                            <a href="{{ route('books.filter', $category->category_id) }}"
            ...
            <button data-modal-target="bookAdd" data-modal-toggle="bookAdd"
                ...
                Add
                <svg class="w-4 h-4 text-white dark:text-white ml-1" aria-hidden="true"
            ...
            {{-- Button untuk refresh halaman admin --}}
            <a href={{ route('books.sort') }}
            ...
            <div id="bookAdd" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        {{-- Form modal untuk add book yang mengarah ke fungsi storeBooks di BooksController --}}
                            ...
                            <div class="grid gap-4 mb-4 grid-cols-2">
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    ...
                                    <input type="text" name="price" id="price" pattern="^\d+(\.\d{1,2})?$"
                                        title="Please enter a valid price. Must be a number with up to two decimal places (e.g., 10.99)"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        required="">
                                </div>
                                <div class="col-span-2 sm:col-span-1">
        ...
        <div class="relative">
            ...
            {{-- Form untuk mencari data buku sesuai judul yang diberikan menggunakan fungsi getSearchBook di  BooksController --}}
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-white uppercase bg-[#253644]">
            <tr>
                {{-- variabel untuk melakukan sorting --}}
                @php
                ...
                <th scope="col" class="px-6 py-4">
                    <div class="flex items-center">
                        {{-- Sorting buku sesuai jumlah stock --}}
                ...
                <th scope="col" class="px-6 py-4">
                    <div class="flex items-center">
                        {{-- Sorting buku sesuai abjad kategori --}}
        ...
        <tbody>
            ...
            {{-- Print data buku --}}
                @foreach ($books as $item)
                    <tr class="bg-[#1A2730] border-b border-[#253644] hover:bg-[#1F2F3A] dark:hover:bg-gray-600">
                        <td class="w-4 p-4">
                            <div class="flex items-center">
                                ...
                                <div class="relative p-4 w-full max-w-2xl max-h-full">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div
                                            ...
                                            {{-- Form delete books sesuai buku yang dipilih menggunakan fungsi delBooks di BooksController --}}
                                            <form action="{{ route('books.delete', $item->book_id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button data-modal-hide="bookDelete{{ $item->book_id }}"
                                                    type="submit"
                            ...
                            <div id="bookEdit{{ $item->book_id }}" tabindex="-1" aria-hidden="true"
                                ...
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        {{-- Form edit books sesuai buku yang dipilih menggunakan fungsi updateBooks di BooksController --}}
                ...
                @endforeach
            @else
                {{-- Jika data buku kosong, maka akan menampilkan text di bawah --}}
