            ...
            @foreach ($books as $category)
                <tr
                    ...
                    <th scope="row" class=" px-3 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                        <div class="ps-3">
                            <div class="text-base font-semibold">{{ $category->category->name}}</div>
                        </div>
                    </th>
                    <td class="px-6 py-4">
                        ...
                        <button type="button"
                            ...
                            data-modal-target="categoryDelete{{ $category->category_id }}"
                            data-modal-toggle="categoryDelete{{ $category->category_id }}">
                        ...
                        {{-- Modal Delete Books --}}
                        <div id="categoryDelete{{ $category->category_id }}" tabindex="-1" aria-hidden="true"
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div
                                        ...
                                        <form action="{{ route('categories.delete', $category->category_id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button data-modal-hide="categoryDelete{{ $category->category_id }}" type="submit"
                                        ...
                                        <button data-modal-hide="categoryDelete{{ $category->category_id }}" type="button"
