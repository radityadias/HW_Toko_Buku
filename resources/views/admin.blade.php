...
<body>
    ...
    <div class="p-4 sm:ml-64 bg-[#121B22]">
            ...
            @section('content')
                ...
                @if (session('error'))
                    <div id="toast-warning"
                        class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 absolute z-50 left-1/2"
                        role="alert">
                        <div
        ...
        {{-- Memanggil component categories table serta passing data dari BooksController --}}
        <div class="p-4 sm:ml-64 bg-[#121B22]">
        ...
        {{-- Memanggil component sales table serta passing data dari BooksController --}}
        <div class="p-4 sm:ml-64 bg-[#121B22]">
            <div class="p-4 bg-[#283C49] rounded-[10px]">
        ...
        {{-- Memanggil component user table serta passing data dari BooksController --}}
        <div class="p-4 sm:ml-64 bg-[#121B22]">
            <div class="p-4 bg-[#283C49] rounded-[10px]">
        ...
        {{-- Fungsi memanggil library Flowbite --}}
