    ...
    <div class="bg-[#1A2731] shadow-md rounded-lg overflow-hidden">
        @if(isset($cart) && count($cart) > 0)
            ...
            <div class="px-6 py-4 bg-[#F9F2EB] dark:bg-gray-700 flex justify-between items-end">
                ...
                @if ($disabled)
                    <button onclick="checkout()" class="checkout-button text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition duration-300 ease-in-out">
                        Checkout
                    </button>
                @else
